                                                                ...
                                                                ?>
                                                                    <div class="col-lg-4 col-md-6">
                                                                        <div class="form-check">
                                                                            <input type="checkbox" value="<?php echo $role['MenuID'];?>" class="form-check-input chk-assigned">
                                                                            <label for="" class="form-check-label"><?php echo $role['MenuName'];?></label>
                                                                        </div>
                                                                    </div>
                                                                <?php
                                                                        }
                                                                        ...
                                                                        // var_dump($unassigned);
                                                                         if($unassigned){
                                                                            foreach ($unassigned as $role) { 
                                                                                $label_id = str_replace(" ","-",$role['MenuName']);
                                                                                ?>
                                                                                <div class="col-lg-4 col-md-6">
                                                                                    <div class="form-check">
                                                                                        <input type="checkbox" value="<?php echo $role['MenuID'];?>" class="form-check-input chk-unassigned" id="<?php echo $label_id;?>">
                                                                                        <label for="<?php echo $label_id;?>" class="form-check-label"><?php echo $role['MenuName'];?></label>
                                                                                    </div>
                                                                                </div><?php
                                                                            }
                                                                         }
